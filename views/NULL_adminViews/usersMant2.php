...
<head>
    ...
    <script>
        function adminCerrarSesion() {
            window.document.form.action = "../../controllers/adminLoginController.php";
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#btnCreateModal").click(function() {
                ...
                // document.getElementById("txt19").value = "";
                // document.getElementById("txt20").value = "";
                // document.getElementById("txt21").value = "";
                $("#txt17").val("No Definido").change();
                $("#txt18").val("0").change();
                $("#txt19").val("No Definido").change();
                ...
                //ocultar txt13
                document.getElementById("divtxt13").setAttribute('style', 'display:none')
                ...
                document.getElementById("divtxt19").setAttribute('style', 'display:none')
            ...
            $('#txt12').on('change', function() {
                if (this.value == 1) {
                    //remove style
                    document.getElementById("divtxt13").removeAttribute('style');
            ...
            $('#txt18').on('change', function() {
                if (this.value == 1) {
                    //remove style
                    document.getElementById("divtxt19").removeAttribute('style');
...
<body>
    ...
    <header>
        <div class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="container">
                <div class="logo"><img src="" width="150" height="60" margin-right="30" style="margin-right: 1rem;"></div>
                ...
                <div class="collapse navbar-collapse" id="navbarHeader">
                    ...
                    <!-- HEADER-->
                    <a id="btnRead" class="btn btn-warning">
                        EXPORTAR TABLA (POR IMPLEMENTAR)<span id="num_cart" class="badge bg-secondary"><?php ?></span>
                    </a>
                    ...
                    <input id="txtbuscar" style="margin-left: 0.4rem; border-radius: 10%;" type="search" placeholder="filtro" aria-label="Search">
                    <form name="form">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3" id="divtxt11">
                    <label class="col-form-label" for="txt11">licenciatura:</label>
                    <select name="select" class="form-control" id="txt11">
                        <!-- OPTIONS -->
                        <?php require '../dependencies/t_o.php';  ?>
                    </select>
                </div>
                <div class="mb-3 bg-info" id="divtxt12">
                    <label class="col-form-label" for="txt12">¿Está laborando?:</label>
                ...
                <div class="mb-3 text-info" id="divtxt13">
                    <label class="col-form-label" for="txt13">area:</label>
                    <input type="text" class="form-control" id="txt13">
                </div>
                <div class="mb-3 text-info" id="divtxt14">
                    <label class="col-form-label" for="txt14">puesto:</label>
                    <input type="text" class="form-control" id="txt14">
                </div>
                <div class="mb-3 text-info" id="divtxt15">
                    <label class="col-form-label" for="txt15">rango_sueldo:</label>
                    <input type="text" class="form-control" id="txt15">
                </div>
                <div class="mb-3 text-info" id="divtxt16">
                    <label class="col-form-label" for="txt16">ubigeo:</label>
                    <input type="text" class="form-control" id="txt16">
                </div>
                <div class="mb-3 text-info" id="divtxt17">
                    <label class="col-form-label" for="txt17">modalidad:</label>
                    <select name="select" class="form-control" id="txt17">
                        <!-- OPTIONS -->
                        <?php require '../dependencies/p_v_h.php';  ?>
                    </select>
                </div>
                <div class="mb-3 bg-warning" id="divtxt18">
                    <label class="col-form-label" for="txt18">¿Continua sus estudios?:</label>
                ...
                <div class="mb-3 text-warning" id="divtxt19">
                    <label class="col-form-label" for="txt19">universidad:</label>
                ...
                <div class="mb-3 text-warning" id="divtxt20">
                    <label class="col-form-label" for="txt20">maestria:</label>
                ...
                <div class="mb-3 text-warning" id="divtxt21">
                    <label class="col-form-label" for="txt21">doctorado:</label>
                ...
                <div class="mb-3 text-warning" id="divtxt22">
                    <label class="col-form-label" for="txt22">especializacion:</label>
                    <input type="text" class="form-control" id="txt22">
                </div>
            </div>
...
<div class="modal fade" id="deleteModalImagen" tabindex="-1" aria-labelledby="deleteModalImagenLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalImagenLabel">Seguro que desea eliminar?</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <label for="txtdel" class="col-form-label">Al aceptar se eliminarán todas las imágenes del directorio</label>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                <button type="button" class="btn btn-danger" id="btnDeleteImagen">Aceptar</button>
            </div>
        </div>
    </div>
</div>
