    ...
    <header>
        <div class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container col">
                <div class="logo"><img src="../../public/images/logo_dre.png" width="150" height="60" margin-right="30" style="margin-right: 1rem;"></div>
                ...
                <div class="collapse navbar-collapse" id="navbarHeader">
                    ...
                    <form action="../../controllers/dataController.php" method="post" style="margin-left: 0.7rem;">
                        <button type="submit" id="export_data" name="exportarCSV" value="Export to excel" class="btn btn-default"><img src="../../public/images/sql_csv.ico" alt="Exportar enXLS" style="width: 70px; height: 70px;"></button>
                    </form>
